...
<nav class="navbar navbar-expand-lg navbar-light "style="background-color: gray;">
	<b>PS-(37)  	Movie Ticket Booking by Team 109 </b>
</nav>
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<div class="collapse navbar-collapse" id="navbarNav">
		<ul class="navbar-nav">
			...
			<li class="nav-item active"><a class="nav-link"
				href="<c:url value="/invoice/search"/>">Current Bookings</a></li>
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="">User List</a>
			...
			<li class="nav-item active"><a class="nav-link"
				href="<c:url value="/invoice/search"/>">Your Bookings</a></li>
			<%-- <li class="nav-item active"><a class="nav-link"
				href="<c:url value="/invoice/detail/search"/>">Invoice</a></li> --%>
			...
			<li class="nav-item active"><a class="nav-link"
				href="<c:url value="/ctl/profile"/>">Profile</a></li>
